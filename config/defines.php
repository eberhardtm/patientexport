...
define('PATIENT_DEMOGRAPHICS', 'patient-policies.txt');
define('PATIENT_ENCOUNTERS','encounters.txt');
define('PATIENT_GENERAL_NOTES', 'general-notes.txt');
define('PATIENT_VITALS','vitals.txt');
define('PATIENT_PROBLEMS', 'problems.txt');
define('PATIENT_MEDICATIONS', 'medications.txt');
